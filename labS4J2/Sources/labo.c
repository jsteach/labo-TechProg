...
/*
* Retourner l'element de la fin de la queue/file sans l'enlever de la queue. 
...
* Utiliser l'age afin de "trie" a chaque push.La personne au premier pop() est la plus jeune.
